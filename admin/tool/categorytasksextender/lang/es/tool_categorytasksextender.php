...
$string['link_text_remove'] = 'Eliminar cursos de';
...
$string['message_error_not_courses_found'] = 'No se encontraron cursos en la  categoría <strong>{$a}</strong>.';
...
$string['message_info_remove_task_queue'] = 'Una Tarea Adhoc para Eliminar cursos ha sido programada para la categoría <strong>{$a}</strong>.';
